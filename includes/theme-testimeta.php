...
$meta_box_testi = array(
	...
	'title' =>  __('Testimonial Options', 'drivingSchool'),
	'page' => 'testi',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Name', 'drivingSchool'),
    	   'desc' => __('Input author\'s name. ', 'drivingSchool'),
    	   'id' => $prefix . 'testi_caption',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('URL', 'drivingSchool'),
    	   'desc' => __('Input author\'s URL.', 'drivingSchool'),
    	   'id' => $prefix . 'testi_url',
    	   'type' => 'text',
    	   'std' => ''
    	),
			array(
    	   'name' => __('Info', 'drivingSchool'),
    	   'desc' => __('Input author\'s additional info.', 'drivingSchool'),
...
function my_show_box_testi() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for testimonial. ', 'drivingSchool').'</p>';
