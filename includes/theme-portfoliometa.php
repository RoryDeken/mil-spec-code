...
$meta_box_portfolio = array(
  ...
  'title'    => __( 'Portfolio Options', 'theme' ),
  'page'     => 'portfolio',
  'context'  => 'normal',
  'priority' => 'high',
  'fields'   => array(
    array(
      ...
      'desc'    => __( 'Choose post format that most fit your needs. ', 'theme' ),
    ...
    array(
      'name' => __( 'Date', 'theme' ),
      'desc' => __( 'Input project end date. ', 'theme' ),
      'id'   => $prefix . 'portfolio_date',
      'type' => 'text',
      'std'  => ''
    ),
    array(
      'name' => __( 'Client', 'theme' ),
      'desc' => __( 'Input project owner name. ', 'theme' ),
    ...
    array(
      'name' => __( 'Info', 'theme' ),
      'desc' => __( 'Additional info for this portfolio item.', 'theme' ),
    ...
    array(
      'name' => __( 'URL', 'theme' ),
      'desc' => __( 'Input the project URL (external link)', 'theme' ),
...
$meta_box_portfolio_video = array(
  ...
  'title'    => __( 'Video Settings', 'theme' ),
  'page'     => 'portfolio',
  'context'  => 'normal',
  'priority' => 'high',
  'fields'   => array(
    array(
      'name' => __( 'Embedded Code', 'theme' ),
      'desc' => __( 'Use this field to embed video from various websites (YouTube, Vimeo etc).', 'theme' ),
...
$meta_box_portfolio_audio = array(
  ...
  'title'    => __( 'Audio Settings', 'theme' ),
  'page'     => 'portfolio',
  'context'  => 'normal',
  'priority' => 'high',
  'fields'   => array(
    array(
      "name" => __( 'MP3 File URL', 'theme' ),
      "desc" => __( 'The URL to the .mp3 audio file', 'theme' ),
      "id"   => $prefix . "audio_mp3",
      "type" => "text",
      'std'  => ''
    )
...
function tz_show_box_portfolio() {
  ...
  echo '<p style="padding:10px 0 0 0;">' . __( 'Please choose desired Portfolio Format and fill additional fields. ', 'theme' ) . '</p>';
