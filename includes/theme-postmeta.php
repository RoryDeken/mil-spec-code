...
$meta_box_quote = array(
  ...
  'title'    => __( 'Quote Settings', 'drivingSchool' ),
  'page'     => 'post',
  'context'  => 'normal',
  'priority' => 'high',
  'fields'   => array(
    array(
      "name" => __( 'The Quote', 'drivingSchool' ),
      "desc" => __( 'Put your quote in this field.', 'drivingSchool' ),
      "id"   => $prefix . "quote",
      "type" => "textarea"
    ),
  ),
...
$meta_box_link = array(
  'id'       => 'tz-meta-box-link',
  'title'    => __( 'Link Settings', 'drivingSchool' ),
  'page'     => 'post',
  'context'  => 'normal',
  'priority' => 'high',
  'fields'   => array(
    array(
      "name" => __( 'The URL', 'drivingSchool' ),
      "desc" => __( 'Insert the URL you wish to link to.', 'drivingSchool' ),
      "id"   => $prefix . "link_url",
      "type" => "text"
    ),
  ),
...
$meta_box_image = array(
  ...
  'title'    => __( 'Image Settings', 'drivingSchool' ),
  'page'     => 'post',
  'context'  => 'normal',
  'priority' => 'high',
  'fields'   => array(
    array(
      "name"    => __( 'Enable Lightbox', 'drivingSchool' ),
      "desc"    => __( 'Check this to enable the lightbox.', 'drivingSchool' ),
...
$meta_box_audio = array(
  ...
  'title'    => __( 'Audio Settings', 'drivingSchool' ),
  'page'     => 'post',
  'context'  => 'normal',
  'priority' => 'high',
  'fields'   => array(
    array(
      "name" => __( 'MP3 File URL', 'drivingSchool' ),
      "desc" => __( 'The URL to the .mp3 audio file', 'drivingSchool' ),
      "id"   => $prefix . "audio_mp3",
      "type" => "text"
    )
  ),
...
$meta_box_video = array(
  ...
  'title'    => __( 'Video Settings', 'drivingSchool' ),
  'page'     => 'post',
  'context'  => 'normal',
  'priority' => 'high',
  'fields'   => array(
    array(
      "name" => __( 'Embeded Code', 'drivingSchool' ),
      "desc" => __( 'You can include embeded code here.', 'drivingSchool' ),
